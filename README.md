# Zetta Plan
--- 
|  **Zetta**     |  **OSS**         | :cloud: **AMI Marketplace**  |  :cloud: **Zetta Kubernetes** | :cloud: **Zetta EC2** | **Enterprise**
| :-------------:| :--------------: | :---------------------------:| :----------------------------:|:---------------------:|:---------------: | 
| Auto-Scaling   | Self Managed     |    Self Managed              |      :white_check_mark:       |     :no_entry_sign:   |Self Managed
...
| DDS   | :white_check_mark:     |   :white_check_mark:       |      :no_entry_sign:    |      :no_entry_sign:    |:white_check_mark:
| MQTT   | :white_check_mark:     |   :white_check_mark:       |      :white_check_mark:    |      :white_check_mark:    |:white_check_mark: 
| Record & replay   | :white_check_mark:     |   :white_check_mark:       |      :no_entry_sign:      |      :no_entry_sign:    |:white_check_mark:
| rocksdb   | :white_check_mark:     |   :white_check_mark:       |      :no_entry_sign:   |      :no_entry_sign:    |:white_check_mark: 
| Stats   | Limited     |   :white_check_mark:       |      :white_check_mark:    |      :white_check_mark:    |:white_check_mark: 
|  **Storage** 
| File system   | :white_check_mark:     |   :white_check_mark:       |      :no_entry_sign:    |     :no_entry_sign:   |:white_check_mark:
| Influxdbv1   | :white_check_mark:     |   :no_entry_sign:        |     :no_entry_sign:      |     :no_entry_sign:      |:white_check_mark: 
...
| Shared memory   | :no_entry_sign:   |   :white_check_mark:       |    :no_entry_sign:   |    :no_entry_sign:   |:white_check_mark:
